...
#set the GPU computation enabled
DEVICE = torch.device("cuda") 

#region Load the data
# this is cifar10 data 
NUM_CLIENTS = 10
BATCH_SIZE = 32
def load_datasets():
...
#region Train and test function
...
#region Updating the model parameter
...
#to get the updated model parameters from the local model
def get_parameters(net) -> List[np.ndarray]:
    return [val.cpu().numpy() for _, val in net.state_dict().items()]
#endregion 
#region Implement flower client
...
#endregion
#region create instances of flower client
